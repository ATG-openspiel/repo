...
flags.DEFINE_integer("num_train_episodes", int(40010),
...
def main(unused_argv): #需要修改人数，牌数，保存路径
  ...
  with tf.Session() as sess:
    ...
    predict_agent = liars_handcard_predict.card_predict(sess, imperfect_info_state_size, num_dices, num_dice_sides,  num_players, hidden_layers_sizes_predict,
