...
class card_predict(object):
  ...
  def get_imperfect_info_state(self, time_step):
    ...
    private_start = self._num_players + self._num_cards * current_player
    private_end = self._num_players + self._num_cards * current_player + self._num_cards -1
    public_start = self._num_players + self._num_cards * self._num_players
    public_end = self._num_players + self._num_cards * self._num_players + self._num_cards -1
    for i in range(len(origin_info_state)):
      ...
      elif i >=  private_start and i <= private_end:
        imperfect_info_state.append(origin_info_state[i])
      elif i >=  public_start and i <= public_end:
        imperfect_info_state.append(origin_info_state[i])
      elif i>= self._num_players + self._num_cards * self._num_players:
        imperfect_info_state.append(origin_info_state[i])
    return imperfect_info_state
  ...
  def get_legal_cards(self, time_step):
    ...
    origin_info_state = time_step.observations["info_state"][current_player]
    private_start = self._num_players + self._num_cards * current_player
    private_end = self._num_players + self._num_cards * current_player + self._num_cards
    public_start = self._num_players + self._num_cards * self._num_players
    public_end = self._num_players + self._num_cards * self._num_players + self._num_cards 
