...
#ifndef OPEN_SPIEL_GAMES_KUHN_MP_FULL_H_
#define OPEN_SPIEL_GAMES_KUHN_MP_FULL_H_
...
class KuhnGame : public Game {
 public:
  ...
  virtual absl::optional<double> UtilitySum() const override { return 0; }
...
#endif  // OPEN_SPIEL_GAMES_KUHN_POKER_3P_H_
